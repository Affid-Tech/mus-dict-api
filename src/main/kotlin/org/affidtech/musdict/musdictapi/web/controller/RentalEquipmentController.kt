...
import org.affidtech.musdict.musdictapi.service.RentalEquipmentService
...
@RestController
@RequestMapping("/api/v1/locations/{id}/rental/equipment")
class RentalEquipmentController(
	private val service: RentalEquipmentService
) {
	@GetMapping
